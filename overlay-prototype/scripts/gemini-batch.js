...
async function processDesign(designId, imagePath, catalog, ai, model) {
  ...
  const prompt = [
    ...
    '- "d" — Medium sized, red text. The price and calorie values share uniform, equivalent styling. This and group f are the only groups that has equivalent price and',
